...
def templates() -> dict[str, str]:
    ...
    return {
        ...
        "post_review": "\n\n".join([
            ...
            "liste vide si les documents ne demandent pas de conseiller. unsupported_claims : chaque affirmation de "
            "<reponse_proposee> (tarif, délai, droit, existence ou absence d'une offre ou d'un service) que les "
            "documents et les faits n'établissent pas, recopiée telle quelle, y compris l'affirmation qu'une chose "
            "n'existe pas parce que les documents n'en parlent pas ; liste vide si toutes sont établies. Une "
            "salutation, une question au client ou une annonce de transfert ne contient aucune affirmation. Si <reponse_proposee> dit que l'information n'est "
